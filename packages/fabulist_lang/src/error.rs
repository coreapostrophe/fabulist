...
pub enum RuntimeError {
    ...
    AssignmentToNonIdentifier(SpanSlice),
    /// Invalid or unsupported member access was attempted.
    #[error("Invalid memory access.")]
    InvalidMemoryAccess(SpanSlice),

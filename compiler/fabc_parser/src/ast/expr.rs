...
impl Expr {
    pub fn assignment(parser: &mut Parser<'_>) -> Result<Expr, Error> {
    ...
    fn logical(parser: &mut Parser<'_>) -> Result<Expr, Error> {
    ...
    fn equality(parser: &mut Parser<'_>) -> Result<Expr, Error> {
    ...
    fn comparison(parser: &mut Parser<'_>) -> Result<Expr, Error> {
    ...
    fn term(parser: &mut Parser<'_>) -> Result<Expr, Error> {
    ...
    fn factor(parser: &mut Parser<'_>) -> Result<Expr, Error> {
    ...
    fn unary(parser: &mut Parser<'_>) -> Result<Expr, Error> {
    ...
    fn member_access(parser: &mut Parser<'_>) -> Result<Expr, Error> {
    ...
    fn call(parser: &mut Parser<'_>) -> Result<Expr, Error> {
    ...
    fn primary(parser: &mut Parser<'_>) -> Result<Expr, Error> {
        if parser.is_at_end() {
